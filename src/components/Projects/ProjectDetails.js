...
const projects = [
  ...
  // Add more projects as needed
  {
    ...
    description:
      "Real-time weather updates with intuitive design, dynamic data display, and theme toggling functionality",
    details:
      "The Weather Forecast App is a web application designed to provide users with real-time weather forecasts for cities worldwide. Developed using React.js, JavaScript, HTML, CSS, and leveraging the OpenWeather API, this project aims to deliver accurate and up-to-date weather information in an intuitive and visually appealing interface. With features such as real-time data fetching, theme toggling, and city search functionality, the Weather Forecast App enhances user experience and accessibility.",
    technologies: ["React.js", "OpenWeather API", "HTML", "CSS", "JavaScript"],
    contributionPoints: [
      "Real-time Weather Forecasting: The core functionality of the Weather Forecast App revolves around fetching and displaying real-time weather data for cities across the globe. By integrating the OpenWeather API, users can access accurate weather forecasts, including temperature, humidity, wind speed, and more.",
      "Dynamic Data Display: The application dynamically renders weather information in a user-friendly format, ensuring clarity and accessibility. Users can easily view current weather conditions, hourly forecasts, and extended weather predictions for their selected locations.",
